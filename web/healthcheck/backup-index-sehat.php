  ...
  <div class="container">
    <div class="content-body mg-t-90">
      <div class="d-flex flex-row">
          <div>
            <p class="tx-poppins tx-black tx-s-14 tx-md-18 mg-b-0">Selamat Siang,</p>
            <p class="tx-poppins tx-black tx-medium tx-s-20 tx-md-24">Lorem Ipsum</p>
          </div>
          <div class="ms-auto">
            <p class="tx-poppins tx-black tx-s-14 tx-md-18 mg-t-5">Senin, 2 April 2022</p>
          </div>
      </div>
    </div>
    <div class="container">
      <div>
        <h4 class="tx-poppins tx-medium mg-b-10">Informasi</h4>
      </div>
    </div>
    <div class="card">
      ...
      <div class="card-body bd-0 pd-0">
        <div class="row row-xs pd-x-20 pd-y-5">
          <div class="col-12">
            ...
            <p class="tx-poppins tx-medium mg-b-0 crop-text-1">Bagaimana kondisi Anda saat ini? Pilih yang sesuai kondisi Anda.</p>
          </div>
        </div>
      </div>
